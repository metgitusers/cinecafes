   ...
   <body role="document">
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12 headline">
                  <a href="#gallery" class="arrow_dwn"><img src="assets/img/arrow_dwn.jpg" alt=""></a>
                  <h4>Welcome To</h4>
                  <h2>Cine Cafes</h2>
               </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-5">
                        <div class="wel_com_img">
                           <img src="assets/img/welcome_img.jpg" alt="">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="gallery">
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/gallery.jpg" class="big"><img src="assets/img/gallery.jpg" alt="" title="gallery"></a>
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/cine-cafe2.jpg" class="big"><img src="assets/img/cine-cafe2.jpg" alt="" title="gallery"></a>
                           <div class="gallery_txt">
                              <img src="assets/img/search.png" alt=""> 
                           </div>
                        </div>
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/cine-cafe3.jpg" class="big"><img src="assets/img/cine-cafe3.jpg" alt="" title="gallery"></a>
                           <div class="gallery_txt">
                              <img src="assets/img/search.png" alt=""> 
                           </div>
                        </div>
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/gallery2.jpg" class="big"><img src="assets/img/gallery2.jpg" alt="" title="gallery"></a>
                           <div class="gallery_txt">
                              <!--<h4>special offer</h4>-->
                              <img src="assets/img/search.png" alt=""> 
                           </div>
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/gallery33.jpg" class="big"><img src="assets/img/gallery33.jpg" alt="" title="gallery"></a>
                           <div class="gallery_txt">
                              <!--<h4>special offer</h4>-->
                              <img src="assets/img/search.png" alt=""> 
                           </div>
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <div class="gallery_img">
                           <a href="assets/img/gallery44.jpg" class="big"><img src="assets/img/gallery44.jpg" alt="" title="gallery"></a>
                           <div class="gallery_txt">
                              <!--<h4>special offer</h4>-->
                              <img src="assets/img/search.png" alt=""> 
                           </div>
      ...
      <section id="visiters_area">
         <div class="container">
            <div class="row">
               <div class="col-sm-12 headline">
                  <a href="#big_footer" class="arrow_dwn"><img src="assets/img/arrow_dwn.jpg" alt=""></a>
                  <h4>Our Happy</h4>
                  <h2>Visitors</h2>
               </div>
                  ...
                  <div class="col-lg-6 col-md-6 mrg30B">
                     <div class="row contact_txt">
                           ...
                           <table width="100%" border="0">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <p>CAFEPLEX ENTERTAINMENT PRIVATE LIMITED <br>
                                          ECOSPACE ESNT 3A0501, BLOCK -A, 5TH FLOOR, PLOT NO. IIF/11, NEW TOWN, <br> KOLKATA, 24 Parganas North, West Bengal, India, 700156
                                       </p>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td width="85">
                                       <p><i class="fa fa-phone"></i><span>Phone:</span></p>
                                    </td>
                                    <td>
                                       <p> <a href="tel:6290821850">+91 6290821850</a> </p>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td width="85">
                                    ...
                                    <td>
                                       <p><a href="mailto:puja.j@cinecafes.com">puja.j@cinecafes.com</a></p>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
                        ...
                        <div class="col-sm-12">
                           ...
                           <img src="assets/img/cinecafe-map.jpg" alt="">
                        </div>
                     </div>
                  </div>
                  <div class="clearfix"></div>
         ...
         <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body" id="contact_page">
                  ...
                  <!-- <h4>INTRODUCTION</h4> -->
                  <p>
                     Your privacy is vital for <a href="www.cinecafes.com">www.cinecafes.com</a>. We recognise that you trust us to act responsibly when you choose to provide us with information about yourself. This information helps us to improve your experience with better services and opportunities. This policy discloses to you the processes of information gathering and dissemination. As we grow as a business, this policy may change at times, so please periodically check the Site for updates
                  </p>
                  <h4>INFORMATION WE COLLECT</h4>
                  <p>We ask our users to register with us when they use <a href="www.cinecafes.com">www.cinecafes.com</a> and services (collectively, the "Service"). We collect various information about the user through our online registration process, including the person's name, gender, location, phone number, email address, user name, and password.</p>
                  <p>We automatically track information related to the use of the website and its services. This information may include the URL tracking information, the browser used, the IP address used, pages viewed by a user and other actions taken on the Service. In addition, we may track usage through cookies. A cookie is usually a small file written to a user's hard drive. Cookies may be used to allow automated login. They may contain information such as a Login ID or additional information about preferences or Internet use. </p>
                  <p>We may at times collect correspondence, such as emails or letters, sent to us. In addition, we may collect user responses to online polls, ads, surveys, electronic newsletters and questionnaires.</p>
