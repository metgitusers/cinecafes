...
class MY_Controller extends CI_Controller {
    ...
    protected function front_load_view($data) {
	 $this->load->view('frontend/header_user',$data); 
	 $this->load->view($data['content'],$this->data1);
	 $this->load->view('frontend/footer_user'); 
    }
	...
	*/
	...
	/*public function sendMail($eml, $sub, $msg,$FromName='',$From='')
    {
        ...
        if(empty($From)):
            $From='donotreply@cinecafes.com';
        endif;
        $mail = new PHPMailer;
        $mail->CharSet = 'UTF-8';
        $mail->IsSMTP();
        $mail->Host = 'ssl://cinecafes.com';
        $mail->SMTPAuth = true;
        $mail->Port = 465;
        $mail->Username = 'donotreply@cinecafes.com';
        $mail->Password = 'gwj$^}U7XE@V,^gn8(';
        $mail->Username = "franchise.enquiry@cinecafes.com";
        $mail->Password = 'xMF)]BIvc?m&Vd^a+q';
        $mail->SMTPSecure = "ssl";
        $mail->From = $From;
