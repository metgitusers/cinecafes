              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><img src="<?php echo base_url() ?>public/img/website-logo.png" alt="logo"/></h1>
                  </div>
                 ...
                 <!--  <form class="user" method="post" action="<?= base_url(); ?>login/login_user"> -->
                     <form method="post" id="" role="form" action="<?php echo base_url('commission/Login/submit_login_form');?>" autocomplete="off">
