                                              ...
                                              <div class="row">                            
                                                <div class="col-md-3 offset-1">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="from_dt" name="from_dt" type="text" class="form-control customize_inputdate pickadate" value="<?= !empty($resv_from_date)? $resv_from_date : date('01/m/Y') ;?>"  placeholder="DD/MM/YYYY" />
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label>To Date</label>
                                                    <div class="input-group">
                                                        <input id="to_dt" name="to_dt" type="text" class="form-control customize_inputdate pickadate" value="<?= !empty($resv_to_date)? $resv_to_date : date('d/m/Y') ?>" placeholder="DD/MM/YYYY" />
                                                        <div class="input-group-append">
                                                        <span class="input-group-text">
                                                          <span class="fa fa-calendar-o"></span>
                                                        </span>
