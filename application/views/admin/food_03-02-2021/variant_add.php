...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Food Variant</h1>
          ...
          <div class="form_panel"> 
            ...
            <?php endif ?>             
              <form method="post" id="VariantAddform" role="form" action="<?php echo base_url();?>admin/food/add_variant_content" autocomplete="off"  enctype="multipart/form-data">
                <div class="row">
                 ...
                 <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                     <label>Set as default</label>
                      <input type="radio" id="is_default" name="is_default"  value="1"> Yes
                      <input type="radio" id="is_default" name="is_default"  value="0"> No
                    </div>
                </div>
