            ...
            <div class="card">
              <div class="card-header">
                <div class="page-title-wrap">
                  <h4 class="card-title"><?=isset($details)?'Edit':'Add'?> Item Addons</h4>
                  <a class="title_btn t_btn_list" href="<?= base_url('admin/food/addon'); ?>">
                  <span><i class="fa fa-list-ul" aria-hidden="true"></i></span> Addons List</a>
                </div>
                        ...
                        <div class="row">	                        	
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" onkeypress="nospaces(this)" onkeyup="nospaces(this)" class="form-control" required=""  name="item_name" value="<?=isset($details)?$details['addon_name']:''?>">
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
