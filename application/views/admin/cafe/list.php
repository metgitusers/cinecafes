            ...
            <tr>
              ...
              <td>
                ...
                <img style="height:60px;width:60px;"
                  src="<?php echo  base_url().'public/upload_images/cafe_images/'.$ilist['image']; ?>" alt="Cafe Image">
                <?php  } ?>
                <?php  }else{ ?>
                <img style="height:60px;width:60px;" src="<?php echo base_url();?>public/assets/img/110x110.png"
                  alt="Cafe Image">
                <?php  } ?>
              ...
              <td>
                ...
                <a class="btn btn-success btn-circle btn-sm"
                  href="<?php echo base_url();?>admin/cafe/edit/<?php echo $row['cafe_id'];?>">
                ...
                <a class="delete_cafe btn btn-danger btn-circle btn-sm" id="<?php echo $row['cafe_id']; ?>"
