                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <input type="text" id="membership_registration_dt" name="membership_registration" class="membership_reg_dt form-control" value="<?php echo set_value('membership_registration');?>" placeholder=""/>
                              ...
                              <div class="row">                               
                                ...
                                <div class="col-md-12">
                                        <div class="form-group">
                                          <label>Address</label>
                                          <div class="input-group">
                                            <input type="text" id="address" name="address" class="form-control pickadate" placeholder="" required="" value="<?php echo set_value('address'); ?>" />
                                            <div class="input-group-append">
                                              <span class="input-group-text">
                                                <span class="fa fa-calendar-o"></span>
                                              </span>
                          ...
                          <div class="form-body">
                                ...
                                <div class="row col-sm-12">
                                  ...
                                  <?php //echo $member_package['package_price_id'];exit; ?>
                                    ...
                                    <div class="form-group">
                                      <label>Membership Registration Date</label>
                                      <div class="input-group">
                                        <input type="text" id="edit_membership_reg_dt" name="edit_membership_registration" class="membership_reg_dt form-control" value="<?php if(!empty($member_package['buy_on'])){ echo DATE('d/m/Y',strtotime($member_package['buy_on']));}?>" placeholder="" />
                                        <div class="input-group-append">
                                          <span class="input-group-text">
                                            <span class="fa fa-calendar-o"></span>
                                          </span>
                            ...
                            <div class="row">
                              ...
                              <?php if(!empty($member['profile_img'])): ?>
                                <div class="col-md-4" id="profile_img_div" style="margin-top: 27px;"><img id="profile_image" src="<?php echo base_url().'public/upload_images/profile_photo/'.$member['profile_img']?>" alt="your image" width="100px" height="100px"/></div>   
                              <?php else: ?>
                                <div class="col-md-4" id="profile_img_div" style="margin-top: 27px;"><img id="profile_image" src="<?php echo base_url().'public/upload_images/No_Image_Available.jpg'; ?>" alt="your image" width="100px" height="100px"/></div>
                              <?php endif;?>
                            </div>
                          </div>
