	...
	<div class="container">
		...
		<div class="tab-content" id="nav-tabContent">
		  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
		  	<ul>
		  		<li>
		  			<a href="<?=base_url('public/assets/image/gal-1.jpg')?>" data-fancybox="gallery">
					  <img src="<?=base_url('public/assets/image/gal-1.jpg')?>">
					</a>
		  		</li>
		  		<li>
		  			<a href="<?=base_url('public/assets/image/gal-1.jpg')?>" data-fancybox="gallery">
					  <img src="<?=base_url('public/assets/image/gal-2.jpg')?>">
					</a>
		  		</li>
		  		<li>
		  			<a href="<?=base_url('public/assets/image/gal-1.jpg')?>" data-fancybox="gallery">
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6">
				...
				<a href="#" target="_blank"><img src="<?=base_url('public/assets/image/app-store.png')?>"></a>
				<a href="#" target="_blank"><img src="<?=base_url('public/assets/image/play-store.png')?>"></a>
			</div>
			<div class="col-md-6">
