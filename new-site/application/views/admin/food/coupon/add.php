<div class="main-content">
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <h1 class="h3 mb-2 text-gray-800"><?=isset($details)?'Edit':'Add'?> Food Coupon</h1>
            <p align="right">
                <a href="<?php echo base_url('admin/food/coupon');?>" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                        <i class="fas fa-plus"></i>
                    </span>
                    <span class="text">Food Coupon List</span>
                </a>
            </p>
            ...
            <div class="card">
              <!-- <div class="card-header">
                <div class="page-title-wrap">
                  <h4 class="card-title"><?=isset($details)?'Edit':'Add'?> Food Coupon</h4>
                  <a class="title_btn t_btn_list" href="<?= base_url('admin/food/coupon'); ?>">
                  <span><i class="fa fa-list-ul" aria-hidden="true"></i></span> Food Coupon List</a>
                </div>
              ...
              <div class="card-body">
                <div class="px-3">
                    ...
                    <?php endif ?>
                    <form class="form custom_form_style" method="Post" action="<?= base_url(); ?>admin/food/coupon/store" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">	                        	
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" onkeypress="nospaces(this)" onkeyup="nospaces(this)" class="form-control start-date-1" required  name="start_date" value="<?=isset($details)?date('m-d-Y', strtotime($details['start_date'])):''?>" autocomplete="off">
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" onkeypress="nospaces(this)" onkeyup="nospaces(this)" class="form-control end-date-1" required  name="end_date" value="<?=isset($details)?date('m-d-Y', strtotime($details['end_date'])):''?>" autocomplete="off">
                            </div>
