...
if($this->session->admin['role_id'] == 1){
  ...
  $cafe_id = $this->session->admin['cafe_id'];
}
?>
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><?php  if (empty($reservation)) { ?>  Add <?php }else{ ?> Edit 
          <?php } ?>
               ...
               <div class="col-md-4 col-sm-12 col-xs-12 r_duration">
                  <div class="form-group">
                    <label>Duration*</label>
                     <select class="form-control check-price" id="duration" name="duration" required > 
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 " >
                  <div class="form-group">
                    <label>No of Guests*</label>
                     <select class="form-control check-price" id="no_of_guests" name="no_of_guests" required >
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 " >
                  <div class="form-group">
                    <label>Cafe*</label>                      
                     <select class="form-control check-price" id="cafe_id" name="cafe_id" required onchange="populate_room(this.value);">
                      <option value="">-- Select cafe --</option>
                      <?php foreach($cafe_list as $row1){?>
                        <option value="<?php echo $row1['cafe_id'];?>" data-info="<?= $row1['price']?>" <?php if($cafe_id!= ''){ if($cafe_id == $row1['cafe_id']) {?>selected<?php } }?>><?php echo $row1['cafe_name']."-".$row1['cafe_place'];?></option>
                          <?php } ?>
                        </select>
                    </div>
                </div> 
                 ...
                 <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Reservation for*</label>
                       <select class="form-control" id="reservation_for" name="reservation_for" required onchange="reservation_type_change(this.value);" >
        ...
        <?php
		 ...
		 <?php
				  //print_r($reservation);?>
		 <form method="post" id="ReservationEditform" role="form" action="<?php echo base_url();?>admin/reservation/UpdateReservation/<?php echo $reservation['reservation_id']; ?>" autocomplete="off"  enctype="multipart/form-data">
                <div class="row">
                 <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Reservation Date*</label>
                      <input type="text" name="reservation_date" id="reservation_date" class="form-control" placeholder="Reservation date" autocomplete="off" value="<?php echo $reservation['reservation_date']?>" required>
                    </div>
                </div>
                 <div class="col-md-4 col-sm-12 col-xs-12 r_time">
                  <div class="form-group">
                      <label>Reservation Time*</label>
                      <input type="text" name="reservation_time" id="reservation_time" class="form-control" placeholder="Reservation time" autocomplete="off" value="<?php echo $reservation['reservation_time'];?>" required>
                    </div>
                </div>
               ...
               <div class="col-md-4 col-sm-12 col-xs-12 r_duration">
                     ...
                     <option value="">-- Select duration --</option>
                        <?php
                          for($i=1; $i<=12; $i++){
                            ...
                            <option value="<?php echo $i;?>" <?php if($i==$reservation['duration']){ echo "selected"; }?> ><?php echo $i;?></option> 
                         <?php   
                          }
                        ?>
                    </select>
                    ...
                    <label>No of Guests*</label>
                     ...
                     <option value="">-- Select guest no --</option>
                      ...
                      {?>
                         ...
                         <option value="<?php echo $i;?>" <?php if($i==$reservation['no_of_guests']){ echo "selected"; }?> ><?php echo $i;?></option>
                  ...
                  <div class="form-group">
                    <label>Cafe*</label>
                     <select class="form-control check-price" id="cafe_id" name="cafe_id" required onchange="populate_room(this.value);">
                      <option value="">-- Select cafe --</option>
                      <?php foreach($cafe_list as $row1){?>
                        <option value="<?php echo $row1['cafe_id'];?>" <?php if($row1['cafe_id']==$reservation['cafe_id']){ echo "selected"; }?> data-info="<?= $row1['price']?>"><?php echo $row1['cafe_name']."-".$row1['cafe_place'];?></option>
                          <?php } ?>
                        </select>
                    </div>
                </div> 
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 ">
                  <div class="form-group">
                    <label>Reservation Charge (Rs.)*</label>
                    <input type="text" name="reservation_charge" id="reservation_charge" class="form-control" placeholder="Reservation charge" autocomplete="off" value="<?php echo $reservation['total_price'];?>" readonly >
                    </div>
                </div> 
                <div class="col-md-4 col-sm-12 col-xs-12 ">
                  <div class="form-group">
                    <label>Payment Type*</label>
                     <select class="form-control" id="reservation_type" name="reservation_type" required >
                        <option value="Cash" <?php if($reservation['reservation_type']=="Cash"){ echo "selected";}?>>Cash</option>
                        <option value="Online" <?php if($reservation['reservation_type']=="Online"){ echo "selected";}?>>Online</option>
                        <option value="UPI" <?php if($reservation['reservation_type']=="UPI"){ echo "selected";}?>>UPI</option>
                        <option value="Card" <?php if($reservation['reservation_type']=="Card"){ echo "selected";}?>>Card</option>
                        <option value="Amex" <?php if($reservation['reservation_type']=="Amex"){ echo "selected";}?>>Amex</option>
                      </select>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 " >
                  <div class="form-group">
                    ...
                    <option value="">-- Select media type --</option>
                     <?php foreach($media_list as $row1){?>
                            <option value="<?php echo $row1['media_name'];?>" <?php if($row1['media_name']==$reservation['media_type']){ echo "selected"; }?>><?php //echo $row1['cafe_id'];?><?php echo $row1['media_name'];?></option>
                             <?php } ?>
                    </select>
                    </div>
                </div> 
                 <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Reservation for*</label>
                       <select class="form-control" id="reservation_for" name="reservation_for" required onchange="reservation_type_change(this.value);" >
                       <option value="">-- Select type --</option>
                        <option value="1" <?php if($reservation['reservation_for']==1){ echo "selected";}?>>Member</option>
                        <option value="2" <?php if($reservation['reservation_for']==2){ echo "selected";}?>>Guest</option>
                         <option value="My self" <?php if($reservation['reservation_for']=="My self"){ echo "selected";}?>>My self</option>
                      </select>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 member_dd" style="display: none;">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Mobile</label>
                      <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Mobile" value="<?php echo $reservation['mobile'];?>" >
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Name</label>
                      <input type="text" name="name" id="name" class="form-control" placeholder="Name"  value="<?php echo $reservation['name'];?>" >
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Email Id</label>
                      <input type="email" name="email" id="email" class="form-control" placeholder="Email"  value="<?php echo $reservation['email'];?>" >
                    </div>
                </div>
               <div class="col-md-4 col-sm-12 col-xs-12" id="membership-discount" style="display: none">
                  <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12" id="payable-amount">                                    <?php
				    $total_price = $reservation['total_price'];              
            		$item_price = round($total_price*100/(100+18));
				   	$gst = $total_price-$item_price;
            
				   ?>
                    <p style="font-size: 12px;color: #F68310;" id="item_amt">Sub Total:  <strong><?php echo $item_price;?></strong></p>                     
                    <p style="font-size: 12px;color: #F68310;" id="cgst_amt">CGST @ 9%:  <strong><?php echo ($gst/2);?></strong></p>                     
                    <p style="font-size: 12px;color: #F68310;" id="sgst_amt">SGST @ 9%: <strong><?php echo ($gst/2);?></strong></p>                     
                    <p style="font-size: 16px;color: #F68310;" id="total_amt">Total Amount: <strong><?php echo $reservation['total_price'];?></strong></p>             
                    <!-- <p style="font-size: 12px;color: #F68310;" id="gst_amt">GST Amount: <strong>0</strong></p>  -->                    
                  </div>
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <label>Message</label>
                       <textarea id="message" name="message" class="form-control" placeholder="What is in your mind"><?php echo $reservation['message'];?></textarea>
                    </div>
                </div>
                <input type="hidden" name="discount_amount" id="discount_amount" value="">
                <input type="hidden" name="membership_discount_amount" id="membership_discount_amount" value="">
