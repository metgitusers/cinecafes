...
<img src="<?php echo base_url() ?>public/img/footer_logo.png" alt="logo" />
</a>
<!-- Divider -->
...
<?php
//echo '<pre>';print_r($this->session->admin);
...
?>
   ...
   <hr class="sidebar-divider my-0">
   <!-- Nav Item - home-section  -->
   <li class="nav-item <?php if($this->uri->segment(2)=='content'){ echo"active"; }?>">
...
<?php } else if($this->session->admin['role_id']==16) {
   //for Owner
?>
<li class="nav-item <?php if($this->uri->segment(2)=='dashboard'){ echo"active"; }?>">
   <a class="nav-link" href="<?php echo base_url('admin/dashboard'); ?>">
