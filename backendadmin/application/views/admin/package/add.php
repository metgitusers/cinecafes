<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"> Membership Package</h1>
                  <!-- <a class="title_btn t_btn_list" href="<?= base_url(); ?>admin/package"><span><i class="fa fa-list-ul" aria-hidden="true"></i></span>Membership List</a> -->
                 <p align="right"><a href="<?= base_url(); ?>admin/package" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                    </span>
                    <span class="text">Package List</span></a></p>
...
• - Management reserves the right to change the terms of membership from time to time without any prior notice.
</textarea>
                                </div>
                   ...
                   <!-- <div class="form-group"> -->
                           ...
                           <!--  <div class="col-md-12" id="pkg_div">   
                              <div class="col-md-4">
                                ...
                                <div class="row" id="pkg_div">
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group  pkg_select_div">                        
                                  <label>Membership Type<sup>*</sup>
                                    <!-- <a href="Javascript:void(0);" id="add_more_package_type" style="background: #239c91;margin-left:10px;padding: 0 10px;display: inline-block;color: #fff;float:right; border-radius: 3px; font-size: 12px;text-decoration: none;">Add More</a> --></label>
                                    <select name="package_type_id" class="form-control pkg_type" required>
                                      ...
                                      <?php endif; ?>
                                        ...
                                        <div class="input-group number" style="display:none;"?>;margin-top: 10px;"> Duration:
                                         <input class="number" name="no_of_days" type="text" placeholder="No. of days"  value="" >
                                        </div>
                                         ...
                                         <div class="input-group">
                                          ...
                                          <input class="" type="number" name="discount_percent" placeholder="Discount percentage" value="">
                                         </div>
                                  <!--- added number input box on 15/07/20 by soma --->
                                </div>                                
                              </div>                              
                ...
                <div class="col-md-12 col-xs-2 col-xs-2">
                  <div class="form-group">
  								...
  								<button type="submit" class="btn btn-primary btn-user btn-block"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
				            </div>
                  </div>
                </div> -->
                  <div class="row">
                <div class="col-md-2 col-xs-2 col-xs-2">
                  <div class="form-group">
                    ...
                    <a class="btn btn-primary btn-user btn-block" href="<?php echo base_url().'admin/Package'; ?>">
                                    ...
                                    <div class="form-group pkg_select_div">                                
                                     ...
                                     <!--  <a href="Javascript:void(0);" id="add_more_package_type" style="background: #f9b92d;margin-left:10px;padding: 0 10px;display: inline-block;color: #fff;border-radius: 3px; font-size: 12px;text-decoration: none;">Add More</a>  -->
                                        <select  name="package_type_id" class="form-control pkg_type" required>
                                          ...
                                          <?php if(!empty($package_type)): ?>
                                          <?php   foreach($package_type as $pkg): ?> 
                                                        <option value="<?php echo $pkg['package_type_id']; ?>" <?php if($pkg['package_type_id'] == $package['package_type_id']): echo 'selected';endif;?>><?php echo ucfirst($pkg['package_type_name']); ?></option>
                                          <?php   endforeach; ?>
                                          <?php endif; ?>                                        
                                        </select>
                                        ...
                                        <!--- added number input box on 15/07/20 by soma --->
                                         <div class="input-group number" style="<?php if($package['package_type_id']!='3'){ echo "display:none"; }?>;margin-top: 10px;"> Duration:
                                         <input class="number" name="no_of_days" type="text" placeholder="No. of days"  value="<?php echo $package['no_of_days']; ?>" >
                                        </div>
                                          <!--- added number input box on 15/07/20 by soma --->
                                         ...
                                         <div class="input-group">
                                          ...
                                          <input class="" type="number" name="discount_percent" placeholder="price" value="<?php echo $package['discount_percent']; ?>">
                                         </div>
                                    </div>                                
                                  </div>
