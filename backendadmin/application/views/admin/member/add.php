...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Users Details</h1>
               ...
               <p align="right"><a href="<?php echo base_url();?>admin/member" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                    </span>
                    <span class="text">Users List</span></a></p>
          <div class="form_panel"> 
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                                ...
                                <div id="new_memb_package" class="settlement_inline">
                                  <select id="new_package_id" class="form-control" name="package_id" data-show-subtext="true" data-live-search="true" onchange="cal_exp_date();">
                                    <option value="">Select Package</option>
                                    <?php if(!empty($package)): ?>
                                    <?php   foreach($package as $plist): ?>
                                              <option value="<?php echo $plist['package_id'];?>" package_type_name="<?php echo $plist['package_type_name'];?>" duration="<?php echo $plist['no_of_days'];?>" <?php if(set_value('package_id') ==$plist['package_id']){ echo 'selected'; } ?>><?php echo $plist['package_name']."(".$plist['package_type_name']."-".$plist['package_price'].")";?></option>
                                    <?php   endforeach; ?>
                                    <?php endif; ?>
                                  </select>
                  ...
                  <div class="form-group">
                                 ...
                                 <!--  <div class="col-md-6" id="doc_dt">
                                    <div class="form-group"> -->
                                       <div class="col-md-6 col-sm-12 col-xs-12" id="doc_dt">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                                          <label>Address</label>
                                          <div class="input-group">
                                            <input type="text" id="address" name="address" class="form-control pickadate" placeholder="" value="<?php echo set_value('address'); ?>" />
                        ...
                        <!-- 	<h4 class="form-section">Profile Image:</h4> -->
                          <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                								<label>Profile Image (accept file extention - .gif,.jpg,.png,.jpeg)
                                </div></label>
                                  ...
                                  <input type="file" id="file-input" onkeypress="nospaces(this)" onkeyup="nospaces(this)" name="profile_img" class="form-control" value="" accept=".gif,.jpg,.png,.jpeg">
                  ...
                  <div class="form-group">
            					...
            					<!-- 	<div class="col-md-12 form-actions">
            							...
            							<button type="submit" id="add_btn" class="btn btn-success" onclick="$('.reg_exp_date').prop('readonly',false);">
                ...
                <div class="col-md-4 col-xs-2 col-xs-2">
                  <div class="form-group">
                    ...
                    <a class="btn btn-primary btn-user btn-block" href="<?php echo base_url().'admin/member'; ?>">
                ...
                <button type="submit" id="add_btn" style="margin: 0 !important" class="btn btn-primary btn-user btn-block" onclick="$('.reg_exp_date').prop('readonly',false);">
                  ...
                  <?php
                    ...
                    ?>
                      <form id="edit_form" class="form custom_form_style" method="Post" action="<?= base_url(); ?>admin/member/UpdateMember/<?php echo $member['user_id']; ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                                      <label>Mobile *</label>
                                      <input type="text" onkeypress="nospaces(this)" onkeyup="nospaces(this)" name="mobile" class="form-control mobileNO" required value="<?php echo $member['mobile'];?>" >
                                      <span></span>
                                    </div>
                                    <?php echo form_error('mobile', '<div class="error">', '</div>'); ?>
                                  </div>
                                ...
                                <!--   <div class="form-group col-sm-4" style="margin-bottom: 0;"> -->
                                    ...
                                    <div id="memb_package" class="settlement_inline">
                                      <select id="package_id" class="form-control" name="package_id" data-show-subtext="true" data-live-search="true"  onchange="cal_exp_date_edit();">
                                        <option value=""><?php //echo $member_package['package_id']; ?>Select Package</option>
                                        <?php if(!empty($package)): ?>
                                        <?php   foreach($package as $plist): ?>
                                           <?php// echo  $member_package['package_id']; echo "<br>";?>
                                          <?php //echo "<pre>"; print_r($plist);die;?>
                                                  <option value="<?php echo $plist['package_id'];?>" <?php if(!empty($member_package)){ if(!empty($member_package['package_id']) && $plist['status'] !='0' && $member_package['package_id'] == $plist['package_id']): echo "selected";endif; } ?> package_type_name="<?php echo $plist['package_type_name'];?>" duration="<?php echo $plist['no_of_days'];?>"><?php echo $plist['package_name']."(".$plist['package_type_name']."-".$plist['package_price'].")";?></option>
                                        <?php   endforeach; ?>
                                        <?php endif; ?>
                                      </select>
                                      <span></span>
                                    ...
                                    <input type="hidden" id="old_membership_package_id" value="<?php if(!empty($member_package)){ echo $member_package['package_id']; } ?>">
                                  </div>
                                </div>
                  ...
                  <div class="form-group">
                                          <label>Address</label>
                                            ...
                                            <!-- <input type="text" id="address" name="address" class="form-control pickadate" placeholder="" required="" value="<?php //echo $member['address'];?>" /> -->
                                             <input type="text" id="address" name="address" class="form-control pickadate" placeholder=""  value="<?php echo $member['address'];?>" />
                  ...
                  <div class="form-group">
                          ...
                          <!--   <h4 class="form-section">Profile Image:</h4> -->
                           <!--  <div class="row"> -->
                            <!--   <div class="col-md-6">
                                  <label>Profile Image(accept file extention - .gif,.jpg,.png,.jpeg)</label>
                                  <div class="input-group mb-3">                              
                                    <div class="custom-file">
                                      <input type="file" accept=".gif,.jpg,.png,.jpeg" name="profile_img" class="custom-file-input" id="profile_img">
                                      <label class="custom-file-label" for="inputGroupFile01">Select Image</label>
                  ...
                  <div class="form-group">
                           ...
                           <!--  <div class="col-md-4" id="profile_img_div" style="margin-top: 27px; display:none"><img id="profile_image" src="" alt="your image" width="100px" height="100px"/></div>  -->  
                              ...
                              <?php if(!empty($member['profile_img'])): ?>
                                <div class="col-md-4"  style="margin-top: 27px;"><img id="blah" src="<?php echo base_url().'public/upload_images/profile_photo/'.$member['profile_img']?>" alt="your image" width="100px" height="100px"/></div>   
                              <?php else: ?>
                                <div class="col-md-4" style="margin-top: 27px;"><img id="blah" src="<?php echo base_url().'public/upload_images/No_Image_Available.jpg'; ?>" alt="your image" width="100px" height="100px"/></div>
                              <?php endif;?>
                            </div>
                          <!-- </div> -->
...
<!-- <script src="<?=base_url('public/js/pickadate/picker.js')?>"></script>
<script src="<?=base_url('public/js/pickadate/picker.date.js')?>"></script>
<script src="<?=base_url('public/js/pickadate/picker.time.js')?>"></script>
<script src="<?=base_url('public/js/pickadate/legacy.js')?>"></script>
 <script src="<?=base_url('public/js/jquery.validate.min.js')?>"></script> 

<script src="<?=base_url('public/css/pickadate/pickadate.css')?>"></script> -->
<script type="text/javascript">

$(document).ready(function() {
  var old_membership_package_id = $("#old_membership_package_id").val();
  if(old_membership_package_id !=""){
    $('#membership_id').attr("disabled", "disabled");
  ...
  $('#membership_registration_dt').datepicker({
    ...
    todayHighlight: true,
    setDate: new Date()
  }).on('changeDate', cal_exp_date_edit);



  // $('.reg_exp_date').datepicker({
  //   format: 'dd/mm/yyyy',
  //   //startDate: dob_max_date,
  //   todayHighlight: true,
  //   setDate: new Date()
  // });

// $('#membership_registration_dt').datepicker().on('changeDate', function (ev) {
//     cal_exp_date();
// });

// $('#edit_membership_reg_dt').datepicker().on('changeDate', function (ev) {
//     cal_exp_date_edit();
// });
...
//     var  package_type_id            = $(".package_type_id").is(":checked"); 
//     var  cnt                        = 0;
//     var  member_id                  = '<?php echo $user_id; ?>';
...
//               type: "POST",
//               url: '<?php echo base_url('admin/member/editUniqueMembershipId')?>', 
//               data:{membership_id : membership_id,member_id:'<?php echo $user_id; ?>'},
//               datatype:'html',
//               async:false,
//               success: function(response){
//                 //alert(response);
...
//                 $('.reg_exp_date').datepicker({startDate:membership_reg_dt});
//                 // membership_reg_dt_picker_exp  = membership_reg_dt_exp.pickadate('picker');
//                 // membership_reg_dt_picker_exp.set('startDate', membership_reg_dt);                 
//               }
//             },
//             error:function(response){
//               $.alert({
...
////////////////fn to calculate exp date////////////////////////////////////////////
function cal_exp_date()
{
    //$('.registration_date_container').show();
    var membership_reg_dt = $('#membership_registration_dt').val();
    var package_id   = $('#new_package_id option:selected').val();
    var package_type   = $('#new_package_id option:selected').attr('package_type_name');
    //alert(package_type);
    //return false;
    //var package_number = $('.package_number').val();
    var package_number  = $('#new_package_id option:selected').attr('duration');
      //alert("start date");
      //alert(package_type);
      //alert(package_number);
     if(package_id!="")
      {
        $('#new_membership_id').attr("required", "required");
            $('#edit_expiry_dt').attr("required", "required");
            $('#expiry_dt').attr("required", "required");
          if(membership_reg_dt !=''){
              $.ajax({
                  type: "POST",
                  url: '<?php echo base_url('admin/member/getExpiryDate')?>', 
...
function cal_exp_date_edit()
{
    //$('.registration_date_container').show();

    var membership_reg_dt = $('#edit_membership_reg_dt').val();
    var package_id   = $('#package_id option:selected').val();
    var package_type   = $('#package_id option:selected').attr('package_type_name');
    ...
    //return false;
    //var package_number = $('.package_number').val();
    var package_number  = $('#package_id option:selected').attr('duration');
      //alert("start date");
      //alert(package_type);
      //alert(package_number);
      if(package_id!="")
      {
          if(old_membership_package_id=="" || package_id!=old_membership_package_id)
          {
            $('#membership_id').prop("disabled", false);
            $('#membership_id').val('');
            $('#membership_id').attr("required", "required");
            $('#edit_expiry_dt').attr("required", "required");
            $('#edit_membership_reg_dt').attr("required", "required");
          }
          if(membership_reg_dt !=''){
              $.ajax({
                  type: "POST",
