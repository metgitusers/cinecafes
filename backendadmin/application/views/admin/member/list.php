        ...
        <div class="form-group reserform_panel">
          ...
          <div class="input-group">
            <input id="start_date" name="start_date" type="text" class="form-control"
              value="<?php if(!empty($start_date)): echo $start_date; endif;?>" placeholder="YYYY/MM/DD" />
        ...
        <div class="form-group reserform_panel">
          ...
          <div class="input-group">
            <input id="end_date" name="end_date" type="text" class="form-control"
              value="<?php if(!empty($end_date)): echo $end_date;endif;?>" placeholder="YYYY/MM/DD" />
            <div class="input-group-append">
              <span class="input-group-text">
                <span class="fa fa-calendar-o"></span>
              </span>
      ...
      <div class="col-sm-3">
       ...
       <div class="col-sm-3">
        <p style="text-align: left; margin-top: 30px;">
            ...
            <button type="submit" style="display: inline-block; width: auto; vertical-align: top;margin-right: 10px;" class="btn btn-primary btn-user" id="search_btn">
              <i class="fa fa-search" aria-hidden="true"></i> Search
            </button>
             <button type="button" style="display: inline-block; width: auto; vertical-align: top;margin-right: 10px;" onclick="location.href='<?php echo base_url('admin/member');?>';"
              class="btn btn-primary btn-user">Reset</button>
          </p>
	   </div>
    </div>
