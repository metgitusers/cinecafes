...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Food category</h1>
          ...
          <div class="form_panel"> 
            ...
            <?php endif ?>             
              <form method="post" id="FoodCatAddform" role="form" action="<?php echo base_url();?>admin/foodcategory/add_content" autocomplete="off"  enctype="multipart/form-data">
                <div class="row">
