...
//   }
  ...
  public function doReservation()
  {
    ...
    if($this->checkHttpMethods($this->http_methods[0])){
      ...
      $condition['user_id'] = $user_id;
      $is_exist = $this->mcommon->getRow('reservation', $condition); 
      if(!empty($is_exist)){
        $is_avail_discount = '';
      }else{
        $percentage = $this->mcommon->getRow('appbookingdiscount', $condition=array('id'=>1))['percentage']; 
          ...
          */
          ...
          if($reservation_id)
          {
            ...
            */
            ...
            //is_avail_discount          
            if($is_avail_discount!=''){
        
        
              $total_price  = $payable_amount - ($payable_amount * $is_avail_discount);              
            }else{
  ...
  // do reservation
  // public function doReservation_bk_20_april_2022()
  // {
  //   $result  = array();
  //   $ap=json_decode(file_get_contents('php://input'), true);
