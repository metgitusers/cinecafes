...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Update Banner</h1>
            <p align="right"><a href="<?php echo base_url();?>admin/banner" class="btn btn-primary btn-icon-split">
          ...
          <div class="form_panel"> 
            ...
            <?php endif ?>             
              <form method="post" id="BannerEditform" role="form" action="<?php echo base_url();?>admin/banner/update_content" autocomplete="off"  enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group">
                   ...
                   <?php if(!empty($row['banner_image'])){?>
                        <img src="<?php echo base_url();?>public/upload_images/banner/<?php echo $row['banner_image'];?>" id="blah" style="height:100px;width:100px;">
                        <?php }else{?>
